...
<div class="container-fluid mt-5 text-center">
    ...
    <h2 class="text-dark mb-5 display-4">All Sub-Categories</h2>
    <!-- Section Body : Popular Categories -->
    <div>
        <?php
        require 'inc\all\category-details\men-fashion.php';
        ?>
        <?php
        require 'inc\all\category-details\women-fashion.php';
        ?>
    </div>
</div>